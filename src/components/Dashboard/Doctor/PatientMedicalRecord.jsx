  ...
  useEffect(() => {
    const fetchPatientData = async () => {
      ...
      try {
        ...
        if (!medicalRecordsResponse.ok) throw new Error("Failed to fetch medical record");
        ...
        if (!patientProfileResponse.ok) throw new Error("Failed to fetch patient profile");
            ...
            physicalSymptoms:
              patientProfileData.MedicalHistories?.[0]?.MedicalHistoryPhysicalSymptom?.map(
                (sym) => ({
                  ...
                  severity: sym.PhysicalSymptoms.Description.includes("High") ? "Severe" : "Mild",
                })
              ) || [],
            psychologicalSymptoms:
              patientProfileData.MedicalHistories?.[0]?.MedicalHistorySpecificMentalDisorder?.map(
                (dis) => ({
                  ...
                  severity: dis.MentalDisorders.Description.includes("Mild") ? "Mild" : "Moderate",
                })
              ) || [],
          },
          medicalRecords: [
            {
              ...
              specificMentalDisorders:
                medicalRecordData.MedicalRecordSpecificMentalDisorder?.map((dis) => ({
                  id: dis.SpecificMentalDisordersId,
                  name: dis.MentalDisorders.Name,
                  description: dis.MentalDisorders.Description,
                })) || [],
              psychologicalAssessment: patientProfileData.MedicalHistories?.[0]?.Description,
            },
          ],
        };
    ...
    if (patientId && bookingId) fetchPatientData();
  }, [patientId, bookingId, token]);
          ...
          children: [
                ...
                ...patient.medicalHistory.physicalSymptoms.flatMap((symptom) => [
                  new Paragraph({
                    children: [
                      ...
                      new TextRun(`${symptom.description} (Severity: ${symptom.severity})`),
                    ],
                    spacing: { after: 100 },
                  }),
                ]),
            ...
            ...(patient.medicalHistory.psychologicalSymptoms.length > 0
              ? [
                ...
                ...patient.medicalHistory.psychologicalSymptoms.flatMap((symptom) => [
                  new Paragraph({
                    children: [
                      new TextRun({ text: `• ${symptom.name}: `, bold: true }),
                      new TextRun(`${symptom.description} (Severity: ${symptom.severity})`),
              ...
              ? [
                ...
                ...patient.medicalRecords.flatMap((record) => [
                  new Paragraph({
                    children: [
                      new TextRun({
                        text: `Record Date: ${formatDate(record.createdAt || record.updatedAt)}`,
                        bold: true,
                      }),
                    ],
                    spacing: { after: 100 },
                  ...
                  ...(record.specificMentalDisorders.length > 0
                    ? [
                      ...
                      ...record.specificMentalDisorders.flatMap((disorder) => [
                        new Paragraph({
                          children: [
                            new TextRun({ text: `• ${disorder.name}: `, bold: true }),
                  ...
                  ...(record.psychologicalAssessment
                    ? [
                      new Paragraph({
                        children: [
                          new TextRun({ text: "Psychological Assessment: ", bold: true }),
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <p className="text-gray-700 text-lg font-semibold">Patient information not found.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-5xl h-screen mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  {patient.gender || "N/A"} • {calculateAge(patient.birthDate)} Years Old • ID: {patient.id?.substring(0, 8) || "N/A"}
                </p>
              </div>
            </div>
            <button
              onClick={exportMedicalRecord}
              className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300 flex items-center gap-2 text-sm font-medium"
            >
              <svg
        ...
        <div className="border-t border-gray-200">
          <div className="flex flex-wrap border-b border-gray-200">
            {["overview", "medical record", "medical history", "contact"].map((tab) => (
              <button
                key={tab}
                className={`px-4 py-3 text-sm font-medium transition-colors duration-200 ${activeTab === tab
        ...
        <div className="p-6 space-y-6 overflow-y-auto max-h-[calc(100vh-230px)]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {patient.medicalRecords?.length > 0 && (
                  <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                    ...
                    <p className="text-gray-600 text-sm">
                      {formatDateTime(patient.medicalRecords[0].createdAt || patient.medicalRecords[0].updatedAt)}
                    </p>
                  </div>
                )}
                {(patient.gender || patient.birthDate) && (
                  <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                    ...
                    <p className="text-gray-600 text-sm">
                      {patient.gender || "N/A"} • {calculateAge(patient.birthDate)} Years Old
                    </p>
                  </div>
                )}
              ...
              {patient.medicalRecords?.length > 0 && (
                <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                  ...
                  {patient.medicalRecords.map((record, index) => (
                    <div key={record.id} className={`space-y-2 ${index > 0 ? "border-t pt-4 mt-4" : ""}`}>
                      <h4 className="text-base font-medium text-gray-900">
                        {formatDate(record.createdAt || record.updatedAt)}
                      </h4>
                      <p className="text-gray-600 text-sm">{record.notes || "No notes available"}</p>
                      {record.specificMentalDisorders?.length > 0 && (
                        <div>
                          <h5 className="text-sm font-medium text-gray-700 mt-2">Mental Disorders</h5>
              ...
              {(patient.medicalHistory?.physicalSymptoms?.length > 0 ||
                patient.medicalHistory?.psychologicalSymptoms?.length > 0) && (
                  <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                    ...
                    {patient.medicalHistory?.physicalSymptoms?.length > 0 && (
                      <div className="mb-4">
                        <h4 className="text-base font-medium text-gray-900 mb-2">Physical Symptoms</h4>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          {patient.medicalHistory.physicalSymptoms.map((symptom) => (
                            <div key={symptom.id} className="p-3 bg-blue-50 rounded-lg">
                              <h5 className="font-medium text-blue-800 text-sm">{symptom.name}</h5>
                    ...
                    {patient.medicalHistory?.psychologicalSymptoms?.length > 0 && (
                      <div>
                        <h4 className="text-base font-medium text-gray-900 mb-2">Psychological Symptoms</h4>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          {patient.medicalHistory.psychologicalSymptoms.map((symptom) => (
                            <div key={symptom.id} className="p-3 bg-purple-50 rounded-lg">
                              <h5 className="font-medium text-purple-800 text-sm">{symptom.name}</h5>
                              <p className="text-gray-600 text-xs">
                                {symptom.description} (Severity: {symptom.severity})
                              </p>
                            </div>
          ...
          {activeTab === "medical record" && (
            <div className="space-y-6">
              {(patient.medicalHistory?.diagnosedAt || patient.allergies || patient.personalityTraits) && (
                <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">General Information</h3>
                  <dl className="space-y-2">
                    {patient.medicalHistory?.diagnosedAt && (
                      <div className="flex justify-between items-center py-2 border-b border-gray-100">
                        <dt className="text-gray-600 font-medium text-sm">Diagnosis Date</dt>
                        <dd className="text-gray-800 text-sm">{formatDate(patient.medicalHistory.diagnosedAt)}</dd>
                      </div>
                    )}
                    {patient.allergies && (
                      <div className="flex justify-between items-center py-2 border-b border-gray-100">
                        <dt className="text-gray-600 font-medium text-sm">Allergies</dt>
                        <dd className="text-gray-800 text-sm">{patient.allergies}</dd>
                      </div>
                    )}
                    {patient.personalityTraits && (
                      <div className="flex justify-between items-center py-2 border-b border-gray-100">
                        <dt className="text-gray-600 font-medium text-sm">Personality Traits</dt>
                        <dd className="text-gray-800 text-sm">{patient.personalityTraits}</dd>
                      </div>
                    )}
                  </dl>
                </div>
              ...
              {patient.medicalRecords?.length > 0 && (
                <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Medical Record</h3>
                  {patient.medicalRecords.map((record, index) => (
                    <div key={record.id} className={`space-y-2 ${index > 0 ? "border-t pt-4 mt-4" : ""}`}>
                      <h4 className="text-base font-medium text-gray-900">
                        {formatDate(record.createdAt || record.updatedAt)}
          ...
          {activeTab === "medical history" && (
            <div className="space-y-6">
              {patient.medicalHistory?.physicalSymptoms?.length > 0 && (
                <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Physical Symptoms</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    {patient.medicalHistory.physicalSymptoms.map((symptom) => (
                      <div key={symptom.id} className="p-3 bg-blue-50 rounded-lg flex items-start gap-3">
                        <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center">
                          <span className="text-blue-800 text-sm font-medium">{symptom.name.charAt(0)}</span>
                        </div>
                        <div>
                          <h4 className="font-medium text-blue-800 text-sm">{symptom.name}</h4>
                          <p className="text-gray-600 text-xs">
                            {symptom.description} (Severity: {symptom.severity})
                          </p>
                        </div>
              ...
              {patient.medicalHistory?.psychologicalSymptoms?.length > 0 && (
                <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Psychological Symptoms</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    {patient.medicalHistory.psychologicalSymptoms.map((symptom) => (
                      <div key={symptom.id} className="p-3 bg-purple-50 rounded-lg flex items-start gap-3">
                        <div className="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center">
                          <span className="text-purple-800 text-sm font-medium">{symptom.name.charAt(0)}</span>
                        </div>
                        <div>
                          <h4 className="font-medium text-purple-800 text-sm">{symptom.name}</h4>
                          <p className="text-gray-600 text-xs">
                            {symptom.description} (Severity: {symptom.severity})
                          </p>
                        </div>
                ...
                {patient.contactInfo.email && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800 text-sm">{patient.contactInfo.email}</p>
                    </div>
                  </div>
                )}
                {patient.contactInfo.phone && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800 text-sm">{patient.contactInfo.phone}</p>
                    </div>
                  </div>
                )}
                {patient.contactInfo.address && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800 text-sm">{patient.contactInfo.address}</p>
                    </div>
                  </div>
                )}
              </div>
