...
// Hardcoded activities data with new activities from Post data
const hardcodedActivities = {
  ...
  // New activities for 2025-07-31 from Post data
  session4: [
    {
      id: "act5",
      timeRange: "2025-07-31T20:00:00Z", // Tối (evening)
      duration: "30 minutes",
      status: "Pending",
      PeriodName: "Tối", // Explicitly set from Post data
      therapeuticActivity: {
    ...
    {
      id: "act6",
      timeRange: "2025-07-31T08:00:00Z", // Sáng (morning)
      duration: "30 minutes",
      status: "Pending",
      PeriodName: "Sáng", // Explicitly set from Post data
      therapeuticActivity: {
        name: "Medication Review",
        description: "Review medication schedule with doctor",
        intensityLevel: "Low",
...
const CreateWeeklyPlanner = ({ patientId }) => {
  ...
  const createActivityObject = (activity, time, sessionId) => {
    ...
    return {
      ...
      periodName: activity.PeriodName || getPeriodForTime(timeString), // Use PeriodName from activity if available
    };
  };
